...
<body>
    ...
    <div class="main d-flex">
        ...
        <div class="total flex-grow-1">
            <div class="Title">All Restaurant</div>
            ...
            <div style="overflow-x: auto; width: 100%;">
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                        include "conn.php";
                        $result = $conn->query("SELECT r.*,res_category.c_name FROM restaurant r join res_category on r.c_id=res_category.c_id order by c_id desc;");
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><img src='" . $row["image"] . "' alt='image' width='120' ></td>";
                                echo "<td>" . $row["created_at"] . "</td>";
                                echo "<td>
                             <div class='btns'>
                             <a  class='btn btn-primary mb-2'  href='edit.php?id={$row['rs_id']}'><i class='fa-solid fa-pen' style='font-size:14px;'></i></a>
                            <a class='btn btn-danger' href='delete.php?delete={$row['rs_id']}' onclick=\"return confirm('Are you sure?');\"><i class='fa-solid fa-trash' style='font-size:16px;'></i></a>
                            </div></td></tr>";
                            }
                        } else {

                            echo "<tr><td colspan='12' class='text-center text-danger fw-bold'>No Restaurants Found</td></tr>";
                        }
