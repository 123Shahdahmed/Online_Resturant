...
$user = $conn->query("SELECT * FROM restaurant WHERE rs_id = $id")->fetch_assoc();
...
if ($_POST) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        $sql = "UPDATE restaurant SET image='$upload_path' WHERE rs_id=$id";
    ...
    $conn->query($sql);
    header("Location: all_resturant.php");
    exit;
}
?>
...
<body>
    ...
    <div class="main main_edit d-flex">
        ...
        <div class="al">
            ...
            <div class="total item_udpate">
                <h5 style="color:darkgrey;">Update Restaurant</h5>
                <hr>
                <form class="row g-3" method="POST" enctype="multipart/form-data">
                    <div class="col-md-6">
                        <label for="inputName" class="form-label">Restaurant Name</label>
                        <input type="text" class="form-control" id="inputName" name="name" value="<?= $user['title'] ?>">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputUrl" name="url" value="<?= $user['url'] ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="inputopenh" class="form-label">Open Hours</label>
                        <select class="form-select" name="opn" aria-label="Default select example">
                    ...
                    <div class="col-12">
                        <h5 style="color:darkgrey;">Address
                            <hr>
                            </h3>
                    ...
                    <div class="col-12">
                        ...
                        <a class="btn btn-primary" href="all_resturant.php">Back</a>
