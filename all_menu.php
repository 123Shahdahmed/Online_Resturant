            ...
            <div style="overflow-x: auto; width: 100%;">
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                        include "conn.php";
                        $result = $conn->query("SELECT r.title as res ,d.* FROM restaurant r join dishes d on d.rs_id=r.rs_id order by c_id desc;");
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><img src='" . $row["img"] . "' alt='image' width='120' ></td>";
                                echo "<td>
                             <div class='btns'>
                             <a  class='btn btn-primary mb-2'  href='edit_menu.php?id={$row['d_id']}'><i class='fa-solid fa-pen' style='font-size:14px;'></i></a>
                            <a class='btn btn-danger' href='delete_menu.php?delete={$row['d_id']}' onclick=\"return confirm('Are you sure?');\"><i class='fa-solid fa-trash' style='font-size:16px;'></i></a>
                            </div></td></tr>";
                            }
                        } else {
