...
<body>
    <div class="main">
        <div class="navv">
            <nav class="navbar" style="background-color:black;">
                <div class="container-fluid">
                    ...
                    <a href="admin.php"><i class="fa-solid fa-arrow-right-from-bracket"
                            style="color:aliceblue; font-size:25px;"></i></a>
        ...
        <div class="d-flex justify-content-between">
            <!-- Sidebar -->
            <nav id="sidebar" class="bg-light border-end vh-100 p-4 sidebar">
                <h5 class="text-secondary mb-4 sidebar-text">Home</h5>
                ...
                <ul class="list-unstyled">
                    ...
                    <h6 class="text-secondary mt-4 sidebar-text">Log</h6>
                    ...
                    <li>
                        <a class="d-flex align-items-center mb-2" data-bs-toggle="collapse" href="#restaurantCollapse"
                            role="button" aria-expanded="false" aria-controls="restaurantCollapse">

                            <i class="fa fa-archive me-2"></i>
                            <span class="sidebar-text">Restaurant</span>
                        </a>

                        <div class="collapse ps-4 submenu" id="restaurantCollapse">
                    ...
                    <li>
                        ...
                        <div class="collapse ps-4 submenu" id="menuCollapse">
