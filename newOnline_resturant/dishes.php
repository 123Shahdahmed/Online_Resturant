...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="top-links">
            ...
            <section class="inner-page-hero bg-image dish" data-image-src="admin/images/img/restrrr.png"
                style="background-image: url('admin/images/img/restrrr.png')">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="menu-widget" id="2">
                            ...
                            <div class="collapse show" id="popular2">
                                ...
                                <?php
                                $res_id = $_GET['res_id'];
                                $products = mysqli_query($quer, "SELECT * FROM dishes WHERE rs_id='$res_id'");
                                        ...
                                        <div class="food-item border-bottom py-3">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-lg-3 mt-3 mt-lg-0 text-end">
                                                    ...
                                                    <input class="form-control d-inline-block w-50" type="text" name="quantity"
                                                        value="1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3 mb-4">
                            ...
                            <ul class="list-unstyled d-flex flex-wrap gap-3">
                                ...
                                <li><a href="#"><img src="admin/images/mastercard.png" alt="Mastercard" width="30"></a>
                                </li>
