...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2025 at 04:45 PM
...
(1, 'admin', '123456', 'admin@gmail.com', NULL, '2025-11-28 15:24:35');
...
CREATE TABLE `dishes` (
  ...
  `describtion` varchar(222) NOT NULL,
...
INSERT INTO `dishes` (`d_id`, `rs_id`, `title`, `describtion`, `price`, `img`) VALUES
...
(3, 3, 'Chicken Madeira', 'Chicken Madeira, like Chicken Marsala, is made with chicken, mushrooms, and a special fortified wine. But, the wines are different;', 23.00, '62908bdf2f581.jpg'),
...
INSERT INTO `restaurant` (`rs_id`, `c_id`, `title`, `email`, `phone`, `url`, `o_hr`, `c_hr`, `o_days`, `address`, `image`, `created_at`) VALUES
(1, 1, 'North Street Tavern', 'nthavern@mail.com', '3547854700', 'www.northstreettavern.com', '8am', '8pm', 'mon-sat', '1128 North St, White Plains', '6290877b473ce.jpg', '2025-11-28 15:34:31'),
(2, 2, 'Eataly', 'eataly@gmail.com', '0557426406', 'www.eataly.com', '11am', '9pm', 'Mon-Sat', '800 Boylston St, Boston', '606d720b5fc71.jpg', '2025-11-28 15:34:31'),
(3, 3, 'Nan Xiang Xiao Long Bao', 'nanxiangbao45@mail.com', '1458745855', 'www.nanxiangbao45.com', '9am', '8pm', 'mon-sat', 'Queens, New York', '6290860e72d1e.jpg', '2025-11-28 15:34:31'),
(4, 4, 'Highlands Bar & Grill', 'hbg@mail.com', '6545687458', 'www.hbg.com', '7am', '8pm', 'mon-sat', '812 Walter Street', '6290af6f81887.jpg', '2025-11-28 15:34:31');
...
INSERT INTO `res_category` (`c_id`, `c_name`, `created_at`) VALUES
(1, 'Continental', '2025-11-28 15:30:48'),
(2, 'Italian', '2025-11-28 15:30:48'),
(3, 'Chinese', '2025-11-28 15:30:48'),
(4, 'American', '2025-11-28 15:30:48');
...
--
ALTER TABLE `dishes`
  ADD CONSTRAINT `fk_restaurant` FOREIGN KEY (`rs_id`) REFERENCES `restaurant` (`rs_id`) ON DELETE CASCADE;

--
-- Constraints for table `remark`
--
ALTER TABLE `remark`
  ADD CONSTRAINT `fk_form` FOREIGN KEY (`frm_id`) REFERENCES `users_orders` (`o_id`) ON DELETE CASCADE;

--
-- Constraints for table `restaurant`
--
ALTER TABLE `restaurant`
  ADD CONSTRAINT `fk_category` FOREIGN KEY (`c_id`) REFERENCES `res_category` (`c_id`) ON DELETE CASCADE;
